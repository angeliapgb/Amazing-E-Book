                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="male" type="radio" class="form-control @error('gender_id') is-invalid @enderror" name="gender_id" value="1" required autocomplete="gender_id">{{ __('Male:') }}
                                {{-- <label for="male">Male</label> --}}

                                <input id="female" type="radio" class="form-control @error('gender_id') is-invalid @enderror" name="gender_id" value="2" required autocomplete="gender_id">{{ __('Female:') }}
